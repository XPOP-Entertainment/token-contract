...
contract("XPOP", accounts => {
  ...
  describe("4. locker test", () => {
    ...
    //   assert.equal(transferredAmount, balance.valueOf(), "transfer failed");
    //   await xpop.addInvestorLock(investorLocked1, startsAt, period, count, {
    //     from: locker
    //   });
    ...
    //   assert.equal(investorLockInfo[1], startsAt, "investor locked startsAt is not set well");
    //   assert.equal(investorLockInfo[2], period, "investor locked startsAt is not set well");
    //   assert.equal(investorLockInfo[3], count, "investor locked startsAt is not set well");
    //   try {
    ...
    //   assert.equal(transferredAmount, balance.valueOf(), "transfer failed");
    //   await xpop.addInvestorLock(investorLocked2, startsAt, period, count, {
    //     from: locker
    //   });
    ...
    it("4-8 should investor lock expires", async () => {
      ...
      assert.equal(transferredAmount, balance.valueOf(), "transfer failed");
      await xpop.addInvestorLock(investorLocked3, startsAt, period, count, {
        from: locker
      });
      ...
      investorLockedAmount = await xpop.getInvestorLockedAmount(investorLocked3);
      console.log("time traveled investor locked amount", parseInt(investorLockedAmount, 10), lockedAmount - releasedAmountPerMonth);
